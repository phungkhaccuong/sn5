...
def main():
    ...
    ranked_docs = [{'id': '1778112572153028802', 'text': 'I, for one, am grateful for the sophisticated market participants that keep hedging their locked tokens\n\n&gt;lets us long the best performing coins without paying exorbitant funding rates\n&gt;keep fueling the rallies as their hedge is blown up https://t.co/nWI4Rhqoar', 'created_at': '2024-04-10T17:27:27+00:00', 'username': 'HsakaTrades', 'url': 'https://x.com/HsakaTrades/status/1778112572153028802', 'quote_count': 15, 'reply_count': 81, 'retweet_count': 76, 'favorite_count': 1103},
                   ...
                   {'id': '1774045741532553354', 'text': 'the VCs whinging about the explosion of interest in memecoins are directly responsible for it\n\nwith their incessant predatory tokenomics low float high fdv shenanigans \n\nthey bit the hand that fed them, now the same hand has dropped them off at the shelter, and taken in a more friendly dog', 'created_at': '2024-03-30T12:07:19+00:00', 'username': 'HsakaTrades', 'url': 'https://x.com/HsakaTrades/status/1774045741532553354', 'quote_count': 74, 'reply_count': 224, 'retweet_count': 419, 'favorite_count': 2496},
